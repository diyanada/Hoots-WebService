...
function search_querey()
{
	...
	var url="Quotes_ajax.php?log=todbjssearch";
...
function run_querey()
{
	...
	if(document.getElementById('quote').value == ""){
		...
		if(document.getElementById('quote_id').value == "")	var url="Quotes_ajax.php?log=todbjsadd";
		else var url="Quotes_ajax.php?log=todbjsupdte";
