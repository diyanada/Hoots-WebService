...
{
	var url="User_role_ajax.php?log=todbjssearch";
...
function run_querey()
{
	...
	if(document.getElementById('rl_name').value == ""){
		...
		if(document.getElementById('rl_id').value == "")	var url="User_role_ajax.php?log=todbjsadd";
		else var url="User_role_ajax.php?log=todbjsupdte";
