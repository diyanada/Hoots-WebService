...
require_once '../class/system_strings.php';
  ...
  FROM [PRODUCT_OUTPUT_SIZE] 
	  ...
	  if( $result === false ) {
		...
		echo 'document.getElementById("pos_id").value ="'.$row['ID'].'";';
		echo 'document.getElementById("pos_name").value ="'.$row['NAME'].'";';
		echo 'document.getElementById("pos_words").value ="'.$row['WORD'].'";';
