...
{
	var url="Category_main_ajax.php?log=todbjssearch";
	...
	xmlhttp.open("GET",url 
				 ...
				 +"&category_dname=" + document.getElementById('category_dname').value  
				 ,true);
	xmlhttp.send();  
}
...
function run_querey()
{
	...
	if(document.getElementById('category_name').value == ""){
		alert_str("category_name");
	}
	else if(document.getElementById('category_dname').value == ""){
		alert_str("display_name");
	}
	else if(document.getElementById('category_sor').value == ""){
		alert_str("Short_order");
	}
	

	else{
		if(document.getElementById('category_id').value == "")	var url="Category_main_ajax.php?log=todbjsadd";
		else var url="Category_main_ajax.php?log=todbjsupdte";
	...
	xmlhttp.open("GET",url 
				 ...
				 +"&category_name=" + document.getElementById('category_name').value 
				 +"&category_dname=" + document.getElementById('category_dname').value  
				 +"&category_sor=" + document.getElementById('category_sor').value 
				 ,true);
	xmlhttp.send();  
}
}