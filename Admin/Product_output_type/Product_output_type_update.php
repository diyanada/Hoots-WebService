...
require_once '../class/system_strings.php';
	...
	if( $conn === false ) {
	  ...
	  if( $result === false ) {
		...
		echo 'document.getElementById("pdouty_id").value ="'.$_GET['product_id'].'";';
		echo 'document.getElementById("pdouty_name").value ="'.$row['NAME'].'";';
		echo 'document.getElementById("pdouty_words").value ="'.$row['WORD'].'";';
